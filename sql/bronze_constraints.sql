...
ALTER TABLE financial_market_data.dev.bronze_equities ALTER COLUMN symbol SET NOT NULL;
ALTER TABLE financial_market_data.dev.bronze_equities ALTER COLUMN date SET NOT NULL;

ALTER TABLE financial_market_data.dev.bronze_treasury_yields ALTER COLUMN series_id SET NOT NULL;
ALTER TABLE financial_market_data.dev.bronze_treasury_yields ALTER COLUMN date SET NOT NULL;